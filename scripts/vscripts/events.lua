...
function CTreeTagGameMode:OnNPCSpawned(keys) --All entity spawned will start here
	...
	elseif heroname == "npc_dota_hero_doom_bringer"
	or heroname == "npc_dota_hero_ember_spirit" then
	...
	if heroname == "npc_dota_hero_doom_bringer"
	or heroname == "npc_dota_hero_ember_spirit" then 
	...
	if heroname == "npc_dota_hero_ember_spirit" then
		npc:SetOriginalModel("models/heroes/ember_spirit/ember_spirit.vmdl")
		npc:SetModel("models/heroes/ember_spirit/ember_spirit.vmdl")
	end
...
function StartVictoryTimer()
	...
	Timers:CreateTimer(1955, function()
		...
		allinferno = Entities:FindAllByClassname("npc_dota_hero_ember_spirit")
		DebugPrint("Burnin Special Power Activated")
		for _, infernos in pairs(allinferno) do
		    DebugPrint("Accessed inferno endgame")
		    infernos:AddAbility("inferno_endgame")
		    ability = infernos:FindAbilityByName("inferno_endgame")
