...
function preCacheResources(context)
    ...
    PrecacheResource("model", "models/items/tiny_01/tiny_haunted_tree.vmdl", context)
    ...
    PrecacheResource("model", "models/props_structures/radiant_statue002.vmdl", context)
    ...
    PrecacheResource("model", "models/props_gameplay/npc/shopkeeper_vulture.vmdl", context)
    PrecacheResource("model", "models/items/furion/treant/father_treant/father_treant.vmdl", context)
    ...
    PrecacheResource("model", "models/props_structures/rock_golem/tower_dire_rock_golem.vmdl", context)
